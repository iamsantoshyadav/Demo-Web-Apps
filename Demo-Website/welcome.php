...
<html>
    ...
    <body>
        ...
        <div class="navBar">
            ...
            <a href="#nothing"><span style="float: right;margin-right: 1vw"class="active"><?php echo $firstName." ".$lastName; ?></span> </a>
            <a href="http://localhost/Demo-Website/todaysTask.php"><span style="float: right;margin-right: 1vw">Today's Tasks</span> </a> 
        </div>
        ...
        <div class="content">
            <div class="login">
                <h3 style="text-align: center;padding-top: 5vh;">Welcome <span style="color: lightcoral;padding: 0;"><?php echo $firstName." ".$lastName."."; ?></span></h3><br>
            </div>
